...
export const Kanban = () => {
  ...
  const handleDrop = (e: React.DragEvent, _targetCompleted: boolean) => {
    e.preventDefault();
    if (draggedTodoId) {
      // The TodoCard will handle the toggle through onDragEnd
      // We just need to reset the dragged ID
